...
//自己的设备名和符号链接
#define DeviceName L"\\device\\PBCIrpHook"
#define SymbolicName L"\\dosDevices\\PBCIrpHook"

//要拦截的目标设备名
#define TargetDeviceName L"\\device\\PBCSsdtHook"

#define IOCTL_BASE 0x8000
#define PBC_CTL(i) CTL_CODE(FILE_DEVICE_UNKNOWN, IOCTL_BASE + i, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
NTSTATUS DispatchIoCtl(PDEVICE_OBJECT pDevObj, PIRP pIrp)
{
	...
	DbgPrint("PBCSsdtHook's is hooking!\n");
